...
#define LOCTEXT_NAMESPACE "RayLandSubsystem"

URayLandSubsystem::URayLandSubsystem()
{
}
...
void URayLandSubsystem::RegisterComponent(URayLandComponent* InRayLandComponent)
{
	Components.AddUnique(TWeakObjectPtr<URayLandComponent>(InRayLandComponent));
}

void URayLandSubsystem::UnregisterComponent(URayLandComponent* InRayLandComponent)
{
	Components.Remove(TWeakObjectPtr<URayLandComponent>(InRayLandComponent));
}

void URayLandSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
...
void URayLandSubsystem::Deinitialize()
{
//#if WITH_EDITOR
...
TStatId URayLandSubsystem::GetStatId() const
{
	RETURN_QUICK_DECLARE_CYCLE_STAT(URayLandSubsystem, STATGROUP_Tickables);
}

ETickableTickType URayLandSubsystem::GetTickableTickType() const
{
...
bool URayLandSubsystem::DoesSupportWorldType(const EWorldType::Type WorldType) const
{
...
void URayLandSubsystem::Tick(float DeltaTime)
{
	SCOPE_CYCLE_COUNTER(STAT_RayLandSubsystemTick);
	TRACE_CPUPROFILER_EVENT_SCOPE(URayLandSubsystem::Tick);
	CSV_SCOPED_TIMING_STAT_EXCLUSIVE(RayLand);
	LLM_SCOPE(ELLMTag::RayLand);
