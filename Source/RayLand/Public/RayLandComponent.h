...
#include "RayLandComponent.generated.h"

class FDeferredDecalProxy;
class UMaterialInterface;

class RAYLAND_API FRayLandSceneProxy
{
public:
	FRayLandSceneProxy(const URayLandComponent* InComponent);

	const URayLandComponent* Component;
};
...
class RAYLAND_API URayLandComponent : public USceneComponent
{
